...
#         file_path = ".//sequence_file_1-5000/" + windows_compatible_string(file_name) + "-" + (str(i)) + ".txt"
...
#         time.sleep(0.3)
#         driver.save_screenshot(".//sequence_file_1-5000/" + str(i) + ".png")
